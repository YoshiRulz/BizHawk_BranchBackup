...
namespace BizHawk.Emulation.Cores.Computers.SinclairSpectrum
{
    ...
    */
	public partial class NECUPD765
	{
		...
		/// <remarks>
		/// <list type="bullet">
		/// <item><description>b0..3	DB 	FDD0..3 Busy (seek/recalib active, until succesful sense intstat)</description></item>
		/// <item><description>b4   	CB 	FDC Busy (still in command-, execution- or result-phase)</description></item>
		/// <item><description>b5   	EXM	Execution Mode (still in execution-phase, non_DMA_only)</description></item>
		/// <item><description>b6   	DIO	Data Input/Output (0=CPU->FDC, 1=FDC->CPU) (see b7)</description></item>
		/// <item><description>b7   	RQM	Request For Master (1=ready for next byte) (see b6 for direction)</description></item>
		/// </list>
		/// </remarks>
		...
		/// <remarks>
		/// <list type="bullet">
		/// <item><description>b0,1	US	Unit Select (driveno during interrupt)</description></item>
		/// <item><description>b2  	HD	Head Address (head during interrupt)</description></item>
		/// <item><description>b3  	NR	Not Ready (drive not ready or non-existing 2nd head selected)</description></item>
		/// <item><description>b4  	EC	Equipment Check (drive failure or recalibrate failed (retry))</description></item>
		/// <item><description>b5  	SE	Seek End (Set if seek-command completed)</description></item>
		/// <item><description>b6,7	IC	Interrupt Code (0=OK, 1=aborted:readfail/OK if EN, 2=unknown cmd
		/// or senseint with no int occured, 3=aborted:disc removed etc.)</description></item>
		/// </list>
		/// </remarks>
		...
		/// <remarks>
		/// <list type="bullet">
		/// <item><description>b0  	MA	Missing Address Mark (Sector_ID or DAM not found)</description></item>
		/// <item><description>b1  	NW	Not Writeable (tried to write/format disc with wprot_tab=on)</description></item>
		/// <item><description>b2  	ND	No Data (Sector_ID not found, CRC fail in ID_field)</description></item>
		/// <item><description>b3,6	0 	Not used</description></item>
		/// <item><description>b4  	OR	Over Run (CPU too slow in execution-phase (ca. 26us/Byte))</description></item>
		/// <item><description>b5  	DE	Data Error (CRC-fail in ID- or Data-Field)</description></item>
		/// <item><description>b7  	EN	End of Track (set past most read/write commands) (see IC)</description></item>
		/// </list>
		/// </remarks>
		...
		/// <remarks>
		/// <list type="bullet">
		/// <item><description>b0	MD	Missing Address Mark in Data Field (DAM not found)</description></item>
		/// <item><description>b1	BC	Bad Cylinder (read/programmed track-ID different and read-ID = FF)</description></item>
		/// <item><description>b2	SN	Scan Not Satisfied (no fitting sector found)</description></item>
		/// <item><description>b3	SH	Scan Equal Hit (equal)</description></item>
		/// <item><description>b4	WC	Wrong Cylinder (read/programmed track-ID different) (see b1)</description></item>
		/// <item><description>b5	DD	Data Error in Data Field (CRC-fail in data-field)</description></item>
		/// <item><description>b6	CM	Control Mark (read/scan command found sector with deleted DAM)</description></item>
		/// <item><description>b7	0 	Not Used</description></item>
		/// </list>
		/// </remarks>
		...
		/// <remarks>
		/// <list type="bullet">
		/// <item><description>b0,1	US	Unit Select (pin 28,29 of FDC)</description></item>
		/// <item><description>b2  	HD	Head Address (pin 27 of FDC)</description></item>
		/// <item><description>b3  	TS	Two Side (0=yes, 1=no (!))</description></item>
		/// <item><description>b4  	T0	Track 0 (on track 0 we are)</description></item>
		/// <item><description>b5  	RY	Ready (drive ready signal)</description></item>
		/// <item><description>b6  	WP	Write Protected (write protected)</description></item>
		/// <item><description>b7  	FT	Fault (if supported: 1=Drive failure)</description></item>
		/// </list>
		/// </remarks>
